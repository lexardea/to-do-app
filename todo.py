...
def prompts():
    ...
    # This prompts the user to input a number from 1-4.
    try: 
...
# Use if, elif, else statement to handle the user's input. 
    # User chooses to add task to list:
    if choice == 1:
    ...
    # User chooses to remove a task from the list.    
    elif choice == 2:
    ...
    # User chooses to view their task list.  
    elif choice == 3: 
